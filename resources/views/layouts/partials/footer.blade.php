        ...
        <div class="relative mx-auto max-w-7xl px-6 sm:px-12 py-16 lg:py-20">
            <div class="grid grid-cols-1 gap-12 md:grid-cols-2 lg:grid-cols-4">
                ...
                <nav class="grid grid-cols-2 gap-6 sm:grid-cols-3 md:grid-cols-2" aria-label="Footer" data-reveal>
                    <div>
                        <h4 class="mb-3 text-sm font-semibold text-white">Mapa de la Oferta</h4>
                        <ul class="space-y-2 text-sm">
                            <li><a href="#" class="hover:text-white transition-colors">Inicio</a></li>
                            <li><a href="#proyectos" class="hover:text-white transition-colors">Paquete de Lanzamiento</a></li>
                            <li><a href="#paquetes" class="hover:text-white transition-colors">Otros Planes</a></li>
                            <li><a href="#contacto-medida" class="hover:text-white transition-colors">Proyectos a Medida</a></li>
                        </ul>
                    </div>
                    <div>
                        <h4 class="mb-3 text-sm font-semibold text-white">Servicios Clave</h4>
                ...
                <div class="space-y-5" data-reveal>
                    ...
                    <div class="flex flex-wrap items-center gap-3">
                        <a href="https://instagram.com/_eddndev" target="_blank" rel="noopener" aria-label="Instagram"
                        ...
                        <a href="https://facebook.com/eddndev.studios" target="_blank" rel="noopener" aria-label="Facebook"
                           class="group inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5
                                  transition hover:border-white/20 hover:bg-white/10">
                            <svg class="h-5 w-5 text-blue-300 transition group-hover:scale-110"><use href="#icon-facebook" /></svg>
                        </a>
                        <a href="https://tiktok.com/@eddndev" target="_blank" rel="noopener" aria-label="TikTok"
                           class="group inline-flex h-10 w-10 items-center justify-center rounded-full border border-white/10 bg-white/5
                                  transition hover:border-white/20 hover:bg-white/10">
            ...
            <div class="flex flex-col-reverse items-center justify-between gap-4 text-sm sm:flex-row">
                <p class="text-gray-400">
                    © {{ date('Y') }} edd n’ dev. Las marcas y logos de terceros son propiedad de sus respectivos dueños.
                </p>
